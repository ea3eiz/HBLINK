...
BRIDGES = {
        ...
        'DMR+4370': [
            {'SYSTEM': 'EA3EG', 'TS': 2, 'TGID': 4370, 'ACTIVE': False, 'TIMEOUT': 10, 'TO_TYPE': 'ON',  'ON': [4370], 'OFF': [4000], 'RESET': []},
            {'SYSTEM': 'DMR+4370', 'TS': 2, 'TGID': 9, 'ACTIVE': True, 'TIMEOUT': 2, 'TO_TYPE': 'NONE',  'ON': [], 'OFF': [], 'RESET': []},
        ],    
        'DMR+4371': [
            {'SYSTEM': 'EA3EG', 'TS': 2, 'TGID': 4371, 'ACTIVE': False, 'TIMEOUT': 10, 'TO_TYPE': 'ON',  'ON': [4371], 'OFF': [4000], 'RESET': []},
            {'SYSTEM': 'DMR+4371', 'TS': 2, 'TGID': 9, 'ACTIVE': True, 'TIMEOUT': 2, 'TO_TYPE': 'NONE',  'ON': [], 'OFF': [], 'RESET': []},
        ], 
        'DMR+4374': [
            {'SYSTEM': 'EA3EG', 'TS': 2, 'TGID': 4374, 'ACTIVE': False, 'TIMEOUT': 10, 'TO_TYPE': 'ON',  'ON': [4374], 'OFF': [4000], 'RESET': []},
        ...
        'BM2140': [
            {'SYSTEM': 'EA3EG', 'TS': 2, 'TGID': 2140, 'ACTIVE': False, 'TIMEOUT': 10, 'TO_TYPE': 'ON',  'ON': [2140], 'OFF': [4000], 'RESET': []},
        ...
        'BM21465': [
            ...
            'XLX266-X': [
            {'SYSTEM': 'EA3EG', 'TS': 2, 'TGID': 4024,    'ACTIVE': True, 'TIMEOUT': 10, 'TO_TYPE': 'NONE',  'ON': [4024], 'OFF': [4000], 'RESET': []},
